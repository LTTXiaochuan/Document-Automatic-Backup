...
#define ID_EDIT_MAX_BACKUP_COUNT 1239 //1.3.0 新增：最大保留数
...
void AddTrayIcon(HWND hWnd) {
    ...
    wcscpy_s(nid.szTip, L"Document Automatic Backup V1.2.6");
