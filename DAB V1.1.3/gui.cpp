...
void AddTrayIcon(HWND hWnd) {
    ...
    nid.hIcon = LoadIconW(g_hInstance, MAKEINTRESOURCE(101));
    wcscpy_s(nid.szTip, L"Document Automatic Backup V1.1.3");
...
void Log(const std::wstring& msg) {
    ...
    if (hLogBox && IsWindow(hLogBox)) {
        ...
        SendMessageW(hLogBox, EM_REPLACESEL, 0, (LPARAM)fullMsg.c_str());
    }
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    switch (msg) {
        ...
        case WM_CREATE: {
            ...
            HWND hSourceEdit = CreateWindowW(L"edit", L"", WS_CHILD | WS_VISIBLE | WS_BORDER,
            ...
            HWND hTargetEdit = CreateWindowW(L"edit", L"", WS_CHILD | WS_VISIBLE | WS_BORDER | ES_MULTILINE | ES_AUTOVSCROLL,
